...
public class ErrorMessages {
    ...
    public static final String CREDITOR_BANK_BIC_CODE_SHOULD_BE_SPECIFIED_FOR_TYPE3 = "Creditor_bank_BIC_code value should be specified for PaymentType: TYPE3";
    public static final String CREDITOR_BANK_BIC_CODE_SHOULD_BE_SPECIFIED_ONLY_FOR_TYPE3 = "Creditor_bank_BIC_code value should be specified only for PaymentType: TYPE3";
    public static final String CREDITOR_IBAN_IS_NOT_VALID = "Provided creditor_iban is not valid";
    public static final String CREDITOR_BANK_BIC_CODE_IS_NOT_VALID = "Provided creditor_bank_BIC_code is not valid";
    public static final String DEBTOR_IBAN_IS_NOT_VALID = "Provided debtor_iban is not valid";
    public static final String DEBTOR_IBAN_AND_CREDITOR_IBAN_SHOULD_BE_DIFFERENT = "Provided debtor_iban and creditor_iban should be different";
